...
public class AuthService : IAuthService
{
    ...
    public AuthService(MySqlConnectionFactory factory, JwtTokenService jwt)
    {
        _factory = factory;
        _jwt = jwt;
    }
        ...
        string userAgent)
    {
        ...
        using (var cmd = new MySqlCommand("sp_login_get_user", conn))
        {
            ...
            if (!await reader.ReadAsync())
            {
                ...
                return "Si el usuario existe, se enviará un correo con instrucciones para recuperar la contraseña.";
            }
        ...
        // En producción se enviaría por correo; aquí lo regresamos para probar
        return code;
    }
